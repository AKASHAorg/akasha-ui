...
Here is a list of CSS variables to add to your CSS file, in addition to those described in the [theming](https://ui.shadcn.com/docs/theming) section of the shadcn website.
